...
# Source tree dynamically loads ClientParity so modular Apps Script can work without touching Index.
# Deployment output is fully flattened, therefore strip that loader and inject ClientParity directly.
styles = re.sub(
